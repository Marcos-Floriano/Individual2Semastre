...
class DadosRepositorios {
    ...
    fun cadastrarProcessador(novoProcessador: Processador, id_maquina: Int, fk_empresa: Int) {
        ...
        var rowComponentes = jdbcTemplate.update(
            """
                insert into componente (nome_componente, fabricante, identificador,frequencia,microarquitetura, fk_maquina_componente, fk_empresa_componente, fk_metrica_componente) values
